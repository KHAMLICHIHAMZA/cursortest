...
import {
  AuditAction,
  GpsSnapshotReason as PrismaGpsSnapshotReason,
} from "@prisma/client";
...
type GpsSnapshotReasonType =
  (typeof GpsSnapshotReason)[keyof typeof GpsSnapshotReason];
...
const MANUAL_SNAPSHOT_ROLES: string[] = [
  "SUPER_ADMIN",
  "COMPANY_ADMIN",
  "AGENCY_MANAGER",
];
