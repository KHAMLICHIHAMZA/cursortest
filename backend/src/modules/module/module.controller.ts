...
export class ModuleController {
  ...
  async createModuleDependency(
    @Body() dto: CreateModuleDependencyDto,
    @CurrentUser() user: any,
  ) {
  ...
  async deleteModuleDependency(
    ...
    return this.moduleService.deleteModuleDependency(
      moduleCode,
      dependsOnCode,
      user,
    );
  ...
  @Roles("SUPER_ADMIN")
  @ApiOperation({
    summary: "Activate a module for a company (SUPER_ADMIN only)",
  })
  async activateCompanyModule(
    ...
    return this.moduleService.activateCompanyModule(
      companyId,
      moduleCode,
      user,
    );
  ...
  @Roles("SUPER_ADMIN")
  @ApiOperation({
    summary: "Deactivate a module for a company (SUPER_ADMIN only)",
  })
  async deactivateCompanyModule(
    ...
    return this.moduleService.deactivateCompanyModule(
      companyId,
      moduleCode,
      user,
    );
  ...
  async deactivateAgencyModule(
    ...
    return this.moduleService.deactivateAgencyModule(
      agencyId,
      moduleCode,
      user,
    );
