...
describe("ModuleService", () => {
  ...
  describe("activateCompanyModule", () => {
    ...
    it("should auto-activate missing dependencies", async () => {
      ...
      const result = await service.activateCompanyModule(
        companyId,
        moduleCode,
        superAdmin,
      );
      ...
      expect(mockPrismaService.companyModule.upsert).toHaveBeenCalledTimes(2);
    });
  ...
  describe("deactivateCompanyModule", () => {
    ...
    it("should deactivate company module successfully", async () => {
      ...
      const result = await service.deactivateCompanyModule(
        companyId,
        moduleCode,
        superAdmin,
      );
  ...
  describe("activateAgencyModule", () => {
    ...
    it("should activate agency module successfully", async () => {
      ...
      const result = await service.activateAgencyModule(
        agencyId,
        moduleCode,
        companyAdmin,
      );
  ...
  describe("deactivateAgencyModule", () => {
    ...
    it("should deactivate agency module successfully", async () => {
      ...
      const result = await service.deactivateAgencyModule(
        agencyId,
        moduleCode,
        companyAdmin,
      );
  ...
  describe("getCompanyModules", () => {
    ...
    it("should throw ForbiddenException if user does not have access", async () => {
      ...
      await expect(
        service.getCompanyModules(companyId, otherAdmin),
      ).rejects.toThrow(ForbiddenException);
    });
  ...
  describe("getAgencyModules", () => {
    ...
    it("should throw NotFoundException if agency not found", async () => {
      ...
      await expect(
        service.getAgencyModules(agencyId, companyAdmin),
      ).rejects.toThrow(NotFoundException);
    });
