...
export class SubscriptionController {
  ...
  @Get("light")
  @ApiOperation({
    summary: "Get lightweight subscriptions list (filtered by role)",
  })
  async findAllLight(
    @CurrentUser() user: any,
    ...
    return this.subscriptionService.findAllLight(
      user,
      parsedPage,
      parsedPageSize,
    );
  ...
  @Roles("SUPER_ADMIN")
  @ApiOperation({
    summary: "Restore a suspended subscription (SUPER_ADMIN only)",
  })
