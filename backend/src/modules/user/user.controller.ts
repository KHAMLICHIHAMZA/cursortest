...
export class UserController {
  ...
  @Roles("SUPER_ADMIN", "COMPANY_ADMIN")
  @ApiOperation({
    summary: "Get lightweight paginated users list (filtered by role)",
  })
  async findAllLight(
    ...
    return this.userService.findAllLight(
      user,
      parsedPage,
      parsedPageSize,
      q,
  ...
  async updateMe(@Body() body: UpdateMeDto, @CurrentUser() user: any) {
